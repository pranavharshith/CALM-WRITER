...
| Kind | Pattern |
| --- | --- |
| Skeletons | `Skeleton<Region>` in `components/skeletons/` |
...
- [ ] Screen uses a **shell** from `docs/DEVICES.md`. No new `100vh` / fixed-width page. Overlay uses `.overlay-shell`. Compact tap ≥ `--tap`. Recheck at 320×480 and 1440×900.
