...
export default function ReportModal({ storyId, storyTitle, onClose }) {
  ...
  return (
    <div className="overlay-shell" style={{ zIndex: 1100 }} onClick={onClose}>
      <div
        onClick={(e) => e.stopPropagation()}
        className="overlay-shell__card glass glass--strong"
        style={{ borderRadius: 'var(--radius-lg)', padding: '28px', maxWidth: '460px' }}
      >
        {done ? (
