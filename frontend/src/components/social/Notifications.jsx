...
import { SkeletonNotification, SkeletonNotifications, SkeletonRegion } from '../skeletons';
...
export default function Notifications({ onBack, onNavigate }) {
    ...
    const regionLoading = useRegionLoading(rawLoading && !isFirstLoad);
    ...
    const handleNotificationClick = (notification) => {
        ...
        if (notification.hubId && onNavigate) {
            onNavigate(`/hubs/${notification.hubId}`);
        } else if (notification.storyId && onNavigate) {
